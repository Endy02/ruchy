        ...
        <>
            <div className='date-picker-wrapper'>
                ...
                <div className='date-picker'>
                    <div>
                        <div className='date-icon' onClick={prevDate}>
                    ...
                    <div>
                        <input type='date' className='picker' value={startDate} onChange={(e) => setStartDate(moment(e.target.valueAsDate).format('YYYY-MM-DD'))}/>
                    </div>
                    <div>
                        <div className='date-icon' onClick={nextDate}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
